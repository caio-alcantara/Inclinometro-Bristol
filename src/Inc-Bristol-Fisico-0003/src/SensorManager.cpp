...
// Construtor
SensorManager::SensorManager(MPU9250& sensor) 
    : mpu(sensor) {
...
bool SensorManager::initialize() {
    ...
    return mpu.setup(Config::MPU_I2C_ADDRESS); // Retorno: true se o sensor foi inicializado com sucesso, false caso contrário
}
